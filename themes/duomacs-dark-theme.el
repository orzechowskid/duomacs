;;; duomacs-dark-theme.el --- duomacs dark theme -*- lexical-binding: t; -*-
;;; Summary:
;;; Commentary:
;;; Code:
...
(defconst duomacs-color-background duomacs--color-bluegray-100
...
(defconst duomacs-color-background-highlight-transient duomacs--color-bluegray-600
...
(defconst duomacs-color-background-tertiary duomacs--color-gray-500)
(defconst duomacs-color-comment duomacs--color-green-400)
(defconst duomacs-color-constant duomacs--color-bluegray-400)
(defconst duomacs-color-foreground duomacs--color-gray-800
  "Preferred default foreground color.")
(defconst duomacs-color-foreground-secondary duomacs--color-gray-400)
(defconst duomacs-color-foreground-tertiary duomacs--color-gray-300)
(defconst duomacs-color-function-call duomacs--color-bluegray-500)
...
(defconst duomacs-color-typedef duomacs--color-bluegray-500)
(defconst duomacs-color-string duomacs--color-red-800)
...
(custom-theme-set-faces
 'duomacs-dark
 `(comint-prompt ((t (:foreground ,duomacs-color-foreground))))
 ...
 `(mode-line-inactive ((t (:foreground ,duomacs-color-foreground-secondary :background ,duomacs-color-background-tertiary))))
...
(provide-theme 'duomacs-dark)

(provide 'duomacs-dark-theme)

;;; duomacs-dark-theme.el ends here
